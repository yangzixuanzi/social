...
(function($, window, document) {
  ...
  */
  ...
  var EmojiArea_WYSIWYG = function($textarea, id, options) {
    ...
    // there insert smile click to show all img
    //$textarea.after("<i class='emoji-picker-icon emoji-picker " + this.options.popupButtonClasses + "' data-id='" + id + "' data-type='picker'></i>");
    $('.btn-toolbar-'+$textarea.attr('operate-type')).find('span.emotion').html("<i class='icon-face " + this.options.popupButtonClasses + "' data-id='" + id + "' data-type='picker'></i>")
  ...
  var EmojiMenu = function(emojiarea) {
    ...
    this.$categoryTabs = $(
        '<table class="emoji-menu-tabs"><tr>'
            ...
            + '<td><a class="emoji-menu-tab icon-bell-emoji"></a></td>'
