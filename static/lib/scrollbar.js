...
//			}, 100);
		...
		customInitEvent2:function(){
		    this.update();
		    this.scrollTo('bottom',true);
		},
		// add by lxx. 自定义方法，用于每次'刷新'内容变化时自动定位到底部
		customInitEvent: function() {
		    var This = this;
		    This.text = This.$el.text();
